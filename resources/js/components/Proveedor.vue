            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" class="btn btn-secondary" @click="abrirModal('proveedores','crear')">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" v-model="buscar" @keyup.40="listarProveedores(1,buscar,criterio)" class="form-control" placeholder="Texto a buscar">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <!-- el comando :key es para indicar cual es la clave primaria del array que estoy recorriendo -->
                                <tr v-for="datos in arrayProvedores" :key="datos.id">
                                    <td>
                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="email" v-model="contacto" class="form-control" placeholder="Ingrese su email">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Telefono de Contacto</label>
                                    <div class="col-md-9">
                                        <input type="email" v-model="telefono_contacto" class="form-control" placeholder="Ingrese su email">
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" v-if="tipoaccion == 1" @click="crearProveedor()">Guardar</button>
        ...
        methods : {
            listarProveedores (page, buscar, criterio){
                ...
                axios.get(url).then(function (response) {
                    ...
                    me.arrayProveedores = respuesta.personas.data;
